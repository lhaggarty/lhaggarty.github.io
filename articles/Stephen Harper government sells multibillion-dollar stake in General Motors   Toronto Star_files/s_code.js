...
/*Insert the mobile phone production report suite ID */
sc_phone_prodRSID = "thestarmobilewebphone";

/*Insert the mobile tablet production report suite ID */
sc_tablet_prodRSID = "thestarmobilewebtablet";

/*Insert the desktop dev report suite ID */
sc_desktop_devRSID = "thestardesktopdev";

/*Insert the mobile phone dev report suite ID */
sc_phone_devRSID = "thestarmobilewebphonedev";

/*Insert the mobile tablet dev report suite ID */
sc_tablet_devRSID = "thestarmobileweblight";

/*Insert the Blackberry report suite ID */
sc_bbRSID="thestarmobileweblight";
...
if (containsItemFromList(tloc, production_URLs)){
    //Desktop Production
    s_account=sc_desktop_prodRSID;
    if ((navigator.userAgent.indexOf("Mobile") > -1) && (matchMedia('only screen and (max-width: 767px)').matches)){
        //Mobile Phone Production
        s_account = sc_phone_prodRSID;
    } else if ((navigator.userAgent.indexOf("Mobile") > -1) && (matchMedia('only screen and (max-width: 1024px)').matches)){
        //Tablet Production
        s_account = sc_tablet_prodRSID;
     }
} else{
    //Desktop Development
    ...
    if ((navigator.userAgent.indexOf("Mobile") > -1) && (matchMedia('only screen and (max-width: 767px)').matches)){
        //Mobile Phone Production
        s_account = sc_phone_devRSID;
    } else if ((navigator.userAgent.indexOf("Mobile") > -1) && (matchMedia('only screen and (max-width: 1024px)').matches)){
        //Tablet Production
        s_account = sc_tablet_devRSID;
     }
}

if ((/\.bb\.html$/).test(tloc)) s_account=sc_bbRSID;
