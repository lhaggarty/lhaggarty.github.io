	...
	<div class="video-part" style="overflow-x:hidden">		
			...
			jwplayer("videoPlaybackFrame").onTime(function (event){
				...
				document.getElementById("preInVis").style.width =(ProgressBarBefore+"%");
					...
					ProgressBarBefore = ((inPoint[currentCut])/vidDuration);
					ProgressBarBefore = ProgressBarBefore*100;
					ProgressBarBefore = ProgressBarBefore.toPrecision(2);
					document.getElementById("preInVis").style.width =(ProgressBarBefore+"%");
					
					ProgressBarDuring = ((realVal-inPoint[currentCut])/vidDuration);
			...
			if (videoLoadSwitch==4){
				if (currentCut == totalCutNumber && realVal > outPoint[currentCut]){
	  ...
	  var videoTitleArray=[];
		...
		<div class="col-md-6 col-md-offset-3"> 
		<form role="form" action="multiEditTest.php" entype="multipart/form-data" method="get">
			...
			<input id="videoLinkArray" type="text" style="display:none"/>
				...
				<input type="text" name="SingleOrMulti" id="SingleOrMulti" value="0" style="display:none"/>
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3" id="videoPlayerButtons" style="padding-bottom:40px">
				...
				<button type="button" class="btn btn-warning" id="videoOutPoint" onclick="videoOutPoint()" data-toggle="tooltip" data-placement="bottom" data-delay="400" title="End your edit" style="color:#000;display:none">
					<img src="css/scissors-open-white.png" class="whiteImage" width="15.1" height="14">
					<img src="css/scissors-open-black.png" class="blackImage" width="15.1" height="14">
					<span> END</span>
				</button>
...
// 						document.getElementById("nextEdit").style.display="";
			...
			function submitEdit(){
				...
				if (SingleOrMulti ==1){
					...
					for (currentCut=0;currentCut<=(totalCutNumber);currentCut++) {
						document.getElementById("InTimeCode").value =($( "#InTimeCode" ).val()+"videoStart[]="+inPoint[currentCut]+"&");
						document.getElementById("OutTimeCode").value =($( "#OutTimeCode" ).val()+"videoStop[]="+outPoint[currentCut]+"&");
